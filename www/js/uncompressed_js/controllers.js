app = angular.module('kchahiyo.controllers', ['filterModule']);
...
app.controller('itemSalesCtrl', ['$window','$scope','$stateParams','kchahiyoServices','userAuthServices','configs','serverAddress','$ionicLoading',
